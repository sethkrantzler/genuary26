import{r as e,j as s,c as l,az as c}from"./main-Br0TB_SV.js";import{P as m}from"./PromptHint-DGuPOW_g.js";const d=()=>{const[t,i]=e.useState(0),o=3,r=e.useCallback(a=>{i(n=>(n+1)%o)},[]);return s.jsxs(s.Fragment,{children:[s.jsx(l,{day:28}),s.jsxs(c,{fullscreen:!0,style:{pointerEvents:"none"},children:[s.jsx("style",{children:`
        .ascii-wrapper {
          position: absolute;
          inset: 0;
          display: flex;
