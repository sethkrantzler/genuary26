import{r as t,j as s,c as l,az as c}from"./main-DGyiM5RS.js";import{P as h}from"./PromptHint-JApA2oKQ.js";const f=()=>{const[a,r]=t.useState(0),o=3,i=t.useCallback(e=>{r(n=>(n+1)%o)},[]);return s.jsxs(s.Fragment,{children:[s.jsx(l,{day:28}),s.jsxs(c,{fullscreen:!0,style:{pointerEvents:"none"},children:[s.jsx("style",{children:`
        .ascii-wrapper {
          position: absolute;
          inset: 0;
          display: flex;
