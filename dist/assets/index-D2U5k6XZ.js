import{aC as ne,m as le,V as L,aD as ce,aE as w,aF as V,aG as ee,K as k,aH as me,aI as ue,a1 as fe,z as K,a3 as de,M as he,r as n,aJ as pe,u as j,aK as te,e as P,w as Y,aL as q,a8 as ve,aM as _e,aN as xe,aO as ge,d as re,aP as Se,_ as Me,aQ as X,j as c,aR as Te,c as Ae,aS as ye,q as Re,aT as Ee,aU as De}from"./main-BRigV1yu.js";import{P as we}from"./PromptHint-Bd7p0Qpj.js";import{m as Ie}from"./BufferGeometryUtils-DI1ln3Gd.js";import{O as Ce}from"./OrbitControls-Kiyhplij.js";import{E as be}from"./Environment-DRNem4Nu.js";const Pe=()=>parseInt(ne.replace(/\D+/g,"")),Be=Pe();class Ue extends le{constructor(e=new L){super({uniforms:{inputBuffer:new w(null),depthBuffer:new w(null),resolution:new w(new L),texelSize:new w(new L),halfTexelSize:new w(new L),kernel:new w(0),scale:new w(1),cameraNear:new w(0),cameraFar:new w(1),minDepthThreshold:new w(0),maxDepthThreshold:new w(1),depthScale:new w(0),depthToBlurRatioBias:new w(.25)},fragmentShader:`#include <common>
